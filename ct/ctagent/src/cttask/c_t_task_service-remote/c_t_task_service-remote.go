...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  RetVal AddTask(TaskEntity task)")
	fmt.Fprintln(os.Stderr, "  RetVal ModifyTask(TaskEntity task)")
	fmt.Fprintln(os.Stderr, "  RetVal Execute(TaskEntity task)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := cttask.NewCTTaskServiceClientFactory(trans, protocolFactory)
	...
	case "AddTask":
		...
		argvalue0 := cttask.NewTaskEntity()
		...
		value0 := argvalue0
		fmt.Print(client.AddTask(value0))
		fmt.Print("\n")
		break
	case "ModifyTask":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "ModifyTask requires 1 args")
			flag.Usage()
		}
		arg14 := flag.Arg(1)
		...
		value0 := argvalue0
		fmt.Print(client.ModifyTask(value0))
		fmt.Print("\n")
		break
	case "Execute":
		if flag.NArg()-1 != 1 {
